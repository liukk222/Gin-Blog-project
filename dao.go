...
func init() {
	dsn := "root:2003925liu@tcp(127.0.0.1:3306)/golang_db?charset=utf8mb4&parseTime=True&loc=Local"
...
func (mgr *manager) Redirect(user *model.User) {
	mgr.db.Create(user)
}
